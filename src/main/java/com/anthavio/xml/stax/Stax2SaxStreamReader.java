...
public class Stax2SaxStreamReader {
	 ...
	 *                SAX event sink
	 */
	public Stax2SaxStreamReader(XMLStreamReader staxStreamReader, ContentHandler filter) {
	...
	private void handleComment() throws XMLStreamException {
		/*
		 * XXX implementation is posible trough LexicalHandler
		int textLength = staxStreamReader.getTextLength();
