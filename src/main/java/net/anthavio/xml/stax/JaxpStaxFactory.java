...
import net.anthavio.xml.stax.JaxpStaxEventFactory.StaxEventImplementation;
import net.anthavio.xml.stax.JaxpStaxInputFactory.StaxInputImplementation;
import net.anthavio.xml.stax.JaxpStaxOutputFactory.StaxOutputImplementation;
